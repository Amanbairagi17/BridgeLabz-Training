public class Players{
    ...
    public static int[] getRandomHeights() {
        ...
        for (int i = 0; i < result.length; i++){
			//It generate random number between 150 to 250
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Shortest player height : " + shortest + ", Tallest player height : " + tallest + " and Mean height of team: " + mean);
    }
}